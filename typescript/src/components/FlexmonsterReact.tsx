...
declare var Flexmonster: (config: Flexmonster.Params) => Flexmonster.Pivot;

export module FlexmonsterReact {

	export class Pivot extends React.Component<Flexmonster.Params, undefined> {
		...
		parseProps(config: Flexmonster.Params) {
